...
def main():
    fasta_path = os.path.join(PROJECT_ROOT, "data",
        "augumented_sequence_size100000_length150_deletions0.1_nodeletionseq0.25.fasta"
    )
    model_out = os.path.join(PROJECT_ROOT, "model_out")
    ...
    # This is what creates the files inside model_out/
    glm.train(epochs=1, batch_size=16, lr=2e-4)  # start small for testing
